...
The above mentioned system have been chosen because they outline the current state on systems that are closest to the kind of system this thesis aims for. The goal properties of the system are based on related research concepts.
...
Related systems that contains these properties can contain valuable input for this project. To give an overview and a better comparison - these properties are presented in table \ref{tab:related}.
...
We see that no system supports all properties
