...
\section{Spatial Audio Interaction}
...
% less cognitive load for selective-attention tasks
...
\subsection{Audio menus}

% Maybe Intelligent Headset (Headset Interface)


\section{Related systems}
This section describes the systems that are most related to this project. First each system is presented - then selected properties related to this projects goal of each system are compaired and summarized in a table.
