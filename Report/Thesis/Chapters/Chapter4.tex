...
The views are aligned in a horizontal way with the main view, the AudioMenu, in the center and the Music view to the left and Gesture view to the right. A simple swipe to on of the sides would show the view. Figure \ref{fig:implementationviews} shows the 3 different views.

\begin{figure}[t]
  \centering
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{./Figures/views.png}
    \rule{35em}{1pt}
