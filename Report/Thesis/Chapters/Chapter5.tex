...
To verify hypothesis 1 (page \pageref{sec:evaluationhypothesis}) we used a t-test to compaire circle detection rate between the two systems. The statistical test showed that there was a significant difference in the scores for the Spatial Music Menu (M=0.76, SD=0.06) and the touch and vision-based music player (M=0.65, SD=0.09) conditions; t(88)=1.66, p = 0.028 $<$ 0.05. In other words the circle detection rate is significantly higher when interacting with the Spatial Music Menu while biking.
...
Nasa TLX scores, figure \ref{fig:resultsnasatlx} - usability!
...
% Something about the number of participants, only 5 participants, no statistical arguments but just hints

% Possibly biased participants (friends) wants to perform good

% System drifting problem
