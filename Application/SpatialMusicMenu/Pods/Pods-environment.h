...
// Deezer
#define COCOAPODS_POD_AVAILABLE_Deezer
#define COCOAPODS_VERSION_MAJOR_Deezer 0
#define COCOAPODS_VERSION_MINOR_Deezer 8
#define COCOAPODS_VERSION_PATCH_Deezer 2
